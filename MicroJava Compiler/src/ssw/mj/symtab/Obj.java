...
public class Obj {
    ...
    // If you finished reading the locals of an method, use meth.locals = curScope.locals() and close the scope afterwards
    /**
